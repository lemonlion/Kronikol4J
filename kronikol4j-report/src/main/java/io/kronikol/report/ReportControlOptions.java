...
public record ReportControlOptions(String testRunReportTitle, String htmlReportFileName,
     ...
     *  component diagram on, no standalone mergeable fragment, test-run data on. */
    public static final ReportControlOptions DEFAULTS =
        new ReportControlOptions(null, DEFAULT_HTML_FILE_NAME, true, false, true);
    ...
    /** Two-arg shape (component diagram on, no mergeable data, data on) — back-compatible. */
    public ReportControlOptions(String testRunReportTitle, String htmlReportFileName) {
        this(testRunReportTitle, htmlReportFileName, true, false, true);
    }

    /** Three-arg shape (no mergeable data, data on) — back-compatible. */
    public ReportControlOptions(String testRunReportTitle, String htmlReportFileName,
                                boolean generateComponentDiagram) {
        this(testRunReportTitle, htmlReportFileName, generateComponentDiagram, false, true);
    }

    /** Four-arg shape (data on) — back-compatible. */
    public ReportControlOptions(String testRunReportTitle, String htmlReportFileName,
                                boolean generateComponentDiagram, boolean generateMergeableData) {
    ...
    public ReportControlOptions withTestRunReportTitle(String value) {
        return new ReportControlOptions(value, htmlReportFileName, generateComponentDiagram,
            generateMergeableData, generateTestRunReportData);
    }
