...
/**
 * Configuration for the {@link EventHubsInteractionRecorder}. Java port of the .NET
 * {@code EventHubsTrackingOptions}. Built via {@link #builder()}.
 */
public final class EventHubsTrackerOptions {
    ...
    private EventHubsTrackerOptions(Builder b) {
    ...
    public static EventHubsTrackerOptions forNamespace(String serviceName) {
    ...
    public static final class Builder {
        private String serviceName = "EventHubs";
        ...
        public EventHubsTrackerOptions build() {
            return new EventHubsTrackerOptions(this);
        }
    }
}
