...
/**
 * Configuration for the {@link BigtableInteractionRecorder}. Java port of the .NET
 * {@code BigtableTrackingOptions}. Built via {@link #builder()}.
 */
public final class BigtableTrackerOptions {
    ...
    private final Set<BigtableOperation> excludedOperations;
    private final Supplier<TestInfo> testInfoFetcher;
    private final IdGenerator ids;

    private BigtableTrackerOptions(Builder b) {
    ...
    public Set<BigtableOperation> excludedOperations() { return excludedOperations; }
    public Supplier<TestInfo> testInfoFetcher() { return testInfoFetcher; }
    public IdGenerator ids() { return ids; }

    public static BigtableTrackerOptions forInstance(String serviceName) {
    ...
    public static final class Builder {
        private String serviceName = "Bigtable";
        ...
        private Set<BigtableOperation> excludedOperations = Set.of();
        ...
        public Builder excludedOperations(Set<BigtableOperation> v) {
        ...
        public BigtableTrackerOptions build() {
            return new BigtableTrackerOptions(this);
        }
    }
}
