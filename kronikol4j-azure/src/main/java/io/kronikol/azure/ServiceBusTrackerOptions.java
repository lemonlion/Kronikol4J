...
/**
 * Configuration for the {@link ServiceBusInteractionRecorder} (and the {@code TrackingServiceBusSender}/
 * {@code Receiver} wrappers). Java port of the .NET {@code ServiceBusTrackingOptions}. Built via
 * {@link #builder()}.
 */
public final class ServiceBusTrackerOptions {
    ...
    private ServiceBusTrackerOptions(Builder b) {
    ...
    public static ServiceBusTrackerOptions forNamespace(String serviceName) {
    ...
    public static final class Builder {
        private String serviceName = "ServiceBus";
        ...
        public ServiceBusTrackerOptions build() {
            return new ServiceBusTrackerOptions(this);
        }
    }
}
