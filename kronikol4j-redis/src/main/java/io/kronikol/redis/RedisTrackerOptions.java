...
/**
 * Configuration for {@link RedisInteractionRecorder}. Java port of the .NET
 * {@code RedisTrackingDatabaseOptions} surface used by the tracker. Built via {@link #builder()}.
 */
public final class RedisTrackerOptions {
    ...
    private RedisTrackerOptions(Builder b) {
    ...
    public static RedisTrackerOptions forCache(String serviceName) {
    ...
    public static final class Builder {
        ...
        public RedisTrackerOptions build() {
            return new RedisTrackerOptions(this);
        }
    }
}
